...
<img src="bitly-qr.png" alt="QR code linking to bit.ly/4xgqTCg">
<div>
<div class="bitly-url">bit.ly/4xgqTCg</div>
<div class="bitly-instruction">Open this presentation on your computer.</div>
</div>
</div>
...
::: columns
::: {.column width="58%"}
<div class="navigate-url">Navigate to this URL:<br><strong>byui.edu/ai/tools/chatgpt</strong></div>
...
3. Enter your BYU-I **username**@byui.edu. _(Be careful not to use your other email address instead of your username.)_

::: {.timer-button}
{{< countdown "5:00" class="inline" >}}
:::
:::
:::
...
## Download Codex from [openai.com/codex](https://openai.com/codex/) {.center-title background-color="#1a3a5c"}

::: columns
::: {.column width="36%" .codex-install-copy}
::: {.callout-note appearance="simple"}
...
**ChatGPT option:** access your ChatGPT conversations and account features.

**Codex option:** work with the coding agent to create, edit, and run code.

::: {.codex-timer}
{{< countdown "3:00" class="inline" >}}
:::
:::

::: {.column width="64%"}
<img src="codex-app-screenshot.png" alt="Codex app workspace screenshot" class="codex-app-image">
:::
:::
...
5. Ignore or skip the guide and notifications that appear when the Codex sidebar opens.
...
<p class="sign-in-note"><strong>Sign-in:</strong> If you are already signed in to the Codex app, VS Code should sign you in automatically. Without the Codex app, you will need to sign in.</p>
